...
Overall, the effects of rainfall measured in the current year are much greater in comparison. There is a much clearer pattern between rainfall and the growth of vegetation at smaller timescales which would indicate that a model for $K_t$ based on $r_{t}$ will be more informative.
...
We can easily visualise these differences in the plot below.  
