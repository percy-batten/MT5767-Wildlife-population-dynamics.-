...
## Part B reword
(I didn't want to change what you had written Percy, but reworded it to make it read better. I have put the rewording in this part so if you want to use some of it you can add it to your part).

Thinking biologically about the situation that growth rate, rt, depends upon rainfall, we can see increased rainfall leads to larger amounts of grass for wildebeest to eat, thus leading to healthier animals, giving them a better chance to survive and reproduce.  
