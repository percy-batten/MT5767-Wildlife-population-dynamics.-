...
When $\beta_0$ is close to 0, our model approaches the examples from practical 3, where the rainfall is not modeled at all. Here, our $\beta_{0_2}$ = `r  fit$par2[3]` is similar to the $\beta$ = `r log(2.604)` found when the carrying capacity is fit as a constant. 
