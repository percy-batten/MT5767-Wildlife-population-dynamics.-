...
```
We can easily visualise these differences in Figure 3.2. The low $\beta_0$ value in the t-1 model is characterised by the smooth slope sections bisected by the introduction of the removals beginning in 1977. 
