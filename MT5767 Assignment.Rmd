...
Finally, we want to generate our observation model; this is the number of individuals we would see in a sample taken at time $t$. It is stated there is no double counting, hence every observation estimate should be smaller than the state process model abundance estimate $n_{i,t}$. By this methodology, a binomial distribution was chosen as below, with each age category having the same probability of detection:
