...
### Part B reword
(I didn't want to change what you had written above, but rearranged/reworded it to make it flow better. I have put the rewording in this part so if you want to use some of it you can add it).
